...
class FixationalMovGrating : public Input {
   protected:
    ...
    boost::random::linear_congruential_engine<unsigned long, 16807, 0,
                                              2147483647>
        generator1;
    boost::random::linear_congruential_engine<unsigned long, 16807, 0,
                                              2147483647>
   ...
   public:
    ...
    // 15.0,double period = 10.0,double step = 1.0,double luminance =
    // 100.0,double
    // contrast = 0.5,double orientation = 0.0,double red_weight=1.0,double
    // green_weigh=1.0, double blue_weight=1.0,int t1 = 0,int t2 = 0,int ts =
    // 0);
    FixationalMovGrating(int columns, int rows,
